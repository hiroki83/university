...
Esempio:
    ...
    {4: 3, 2: 2}
    perché il numero 4 si ripete 3 volte e il numero 2 si ripete 2 volte
    e gli altri si ripetono meno di n=2 volte.
'''
...
Esempio:
    ...
    perché le stringhe corrispondenti alle chiavi 'cocoon', 'Car' e 'floor'
    iniziano con un carattere compreso tra 'c' e 'G'.
'''
def func2(dict1, a, b):
    ## Scrivi qui il tuo codice
    pass
...
Infine, la funzione deve ritornare un dizionario in cui:
    - le chiavi sono i numeri delle righe del file input_filename individuate e copiate
...
La riga che non contiene la parola 'CAt' è stata omessa.
